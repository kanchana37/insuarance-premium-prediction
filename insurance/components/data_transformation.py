...
class FeatureGenerator(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, add_bedrooms_per_room=True,
        ...
        children: int index number of children columns
        smoker_ix: int index number of smoker columns
        region_ix: int index number of  region columns
        expenses_ix int index number of expenses columns
        ...
        try:
            ...
            if self.columns is not None:
                ...
                smoker_ix = self.columns.index(COLUMN_SMOKERr)
                region_ix = self.columns.index(COLUMN_REGION)
                expenses_ix=self.columns.index(COLUMN_EXPENSES)
            ...
            self.smoker_ix = smoker_ix
            self.region_ix = region_ix
            self.expenses_ix = expenses_ix
